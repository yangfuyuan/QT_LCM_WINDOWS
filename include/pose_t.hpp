...
int pose_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    ...
    tlen = __double_encode_array(buf, offset + pos, maxlen - pos, &this->xyt[0], 3);
    if(tlen < 0) return tlen; else pos += tlen;
...
int pose_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    ...
    tlen = __double_decode_array(buf, offset + pos, maxlen - pos, &this->xyt[0], 3);
    if(tlen < 0) return tlen; else pos += tlen;
...
{
    uint64_t hash = 0xb9fabd2b652a41afLL;
